...
export default function AdminUsersPage() {
  ...
  const DeleteConfirmModal = ({ user, onClose, onConfirm }) => (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        <h3 className="text-lg font-medium text-gray-900 mb-4">Confirm Delete</h3>        <p className="text-sm text-gray-500 mb-6">
          ...
          <div>
            ...
            <div className="flex space-x-2">
              ...
              <button
                ...
                disabled={selectedUsers.length === 0}
                className="px-3 py-2 bg-yellow-600 text-white text-sm rounded-md hover:bg-yellow-700 disabled:bg-gray-300 disabled:cursor-not-allowed"
              >
