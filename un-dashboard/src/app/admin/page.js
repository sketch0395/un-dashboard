        ...
        <div className="px-6 py-4 border-b border-gray-200">
          <h3 className="text-lg font-medium text-gray-900">Quick Actions</h3>
            ...
            <button
              ...
              className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition duration-200 text-left relative"
            >
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="font-medium text-gray-900">Pending Users</h4>
            ...
            >
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Monitor user sessions</p>
                </div>
              </div>
            </button>
            ...
            >
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Manage session cleanup and monitoring</p>
                </div>
              </div>
            </button>
            ...
            >
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Monitor system performance and optimization</p>
                </div>
              </div>
            </button>
          </div>
