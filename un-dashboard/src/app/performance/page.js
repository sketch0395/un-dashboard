        ...
        <div className="min-h-screen flex bg-gray-950">
            ...
            >
                <div className="flex justify-between items-center mb-4">
                    {!controlsMinimized && <h2 className="text-lg font-semibold text-white">Performance Controls</h2>}
                    <button 
                        className={`bg-gray-700 p-2 rounded-full hover:bg-gray-600 text-white ${controlsMinimized ? 'mx-auto' : ''}`}
