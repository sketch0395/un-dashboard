          ...
          <div className="flex items-center space-x-2">
            {selectedType ? (
              <>
                ...
                />
                <div>
                  <div className="text-white text-sm">{selectedType.name}</div>
                  {showDescription && (
                    <div className="text-gray-400 text-xs">{selectedType.description}</div>
                  )}
                </div>
              </>
            ) : (
              <div className="text-gray-400 text-sm">Select device type</div>
            )}
          </div>
